...
div.innerHTML = `<input type="text" name="ingredient_name[]" required value="${value}">
...
const div = document.createElement("div");
div.className = "dynamic-group";
div.innerHTML = `<textarea name="instruction_step[]" placeholder="Step description" required>${value}</textarea>
<button type="button" class="remove-btn" onclick="this.parentElement.remove()">×</button>`;
