...
<tr>
<td><a href="viewRecipe.php?recipeID=<?php echo $row['id']; ?>"><?php echo ($row['name']); ?></a></td>

<td>
<a href="viewRecipe.php?recipeID=<?php echo $row['id']; ?>">
<img src="<?php echo ($row['photoFileName']); ?>" alt="Recipe Photo">
</a>
</td>
...
<?php if($fav && $fav->num_rows > 0){ ?>
    ...
    <img src="<?php echo ($f['photoFileName']); ?>" alt="Favourite Recipe">
    </a>
