...
<h1 class="welcome">Welcome, <?php echo htmlspecialchars($firstName); ?> 🌿</h1>

<div class="grid">

<!-- My Information -->
<div class="card info">
<img src="uploads/<?php echo htmlspecialchars($photo); ?>" class="profile" alt="Profile Photo">
...
<tr>
<td><a href="viewRecipe.php?recipeID=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['name']); ?></a></td>

<td>
<a href="viewRecipe.php?recipeID=<?php echo $row['id']; ?>">
<img src="<?php echo htmlspecialchars($row['photoFileName']); ?>" alt="Recipe Photo">
</a>
</td>

<td>
<a href="#">
<?php echo htmlspecialchars($row['firstName']); ?><br>
<img src="uploads/<?php echo htmlspecialchars($row['userPhoto']); ?>" class="mini" alt="Creator Photo">
</a>
</td>
...
<?php if($fav && $fav->num_rows > 0){ ?>
    ...
    <img src="<?php echo htmlspecialchars($f['photoFileName']); ?>" alt="Favourite Recipe">
    </a>

    <div>
    <h4><a href="viewRecipe.php?recipeID=<?php echo $f['id']; ?>"><?php echo htmlspecialchars($f['name']); ?></a></h4>

   <form method="POST" class="fav-form">
    <input type="hidden" name="recipeID" value="<?php echo $f['id']; ?>">
    <input type="hidden" name="removeFavourite" value="1">
